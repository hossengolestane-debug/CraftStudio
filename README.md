...
**Phase 10 / 1.0.5** keeps Phases 1–10 and the 1.0.1–1.0.4 hotfixes, and adds a Design Specification Inspector. Confirm Settings → About shows **1.0.5**. Install rebuilt Windows binaries into `E:\CraftStudio Local 1.0.5\` (keep older version folders). See [SPEC_INSPECTOR.md](SPEC_INSPECTOR.md), [OLLAMA_HTTP400_SCHEMA_FIX.md](OLLAMA_HTTP400_SCHEMA_FIX.md), [SPEC_OLLAMA_SCHEMA_FIX.md](SPEC_OLLAMA_SCHEMA_FIX.md), [PERF_OLLAMA_LIVE_ACTIVITY.md](PERF_OLLAMA_LIVE_ACTIVITY.md), [SMOKE.md](SMOKE.md), and [PHASE10.md](PHASE10.md).
