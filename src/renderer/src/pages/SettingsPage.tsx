    ...
    <div className="mx-auto max-w-3xl space-y-5">
      ...
      <Card className="space-y-2" id="about-build">
        ...
        <p className="text-sm text-muted">
          Use this to confirm you launched the 1.0.7 binary, not an older copy left in another folder. Install the rebuilt
          portable/unpacked app into <code>E:\CraftStudio Local 1.0.7\</code> and keep older version folders.
        </p>
        {about ? (
